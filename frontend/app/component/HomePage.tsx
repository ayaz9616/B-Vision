...
//             Think better with <span className="italic font-semibold text-5xl text-indigo-300 tracking-wide" style={{ fontFamily: 'Inter, Segoe UI, Arial, sans-serif' }}>
//   B Vision
// </span>
//           </h1>
...
//           <div className="text-slate-300 text-base sm:text-xl mb-2 font-normal animate-fade-in-up">
//             Succeed with data
//           </div>
//           <StartAnalysisButton />
//         </div>
