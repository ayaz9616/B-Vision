  ...
  return (
    <div className="w-full mb-8">
      <div className="mb-2">
        ...
        {/* 1. Best features in this phone */}
        <div className="mb-2">
          <span className="font-semibold">Best features in <span className="text-blue-700">{getFullPhoneName(phoneData.sentiment_by_brand[0]?.Brand, phoneData.phone)}</span>:</span>
        ...
        {/* 2. Features to improve */}
        <div className="mb-2">
          <span className="font-semibold">Features to improve in <span className="text-blue-700">{getFullPhoneName(phoneData.sentiment_by_brand[0]?.Brand, phoneData.phone)}</span>:</span>
          <ul className="list-disc ml-6 mt-1">
